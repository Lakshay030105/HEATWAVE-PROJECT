...
export const MOCK_WARDS = [
  {
    wardId: 'JPR-W01', name: 'Malviya Nagar', cityId: 'jaipur-01',
    population: 45000, pctElderly: 0.18, pctOutdoorWorkers: 0.22, greenCoverPct: 0.14,
  ...
  {
    wardId: 'JPR-W02', name: 'Mansarovar', cityId: 'jaipur-01',
    population: 78000, pctElderly: 0.12, pctOutdoorWorkers: 0.35, greenCoverPct: 0.08,
    vulnerabilityScore: 78,
    boundary: { type: 'Polygon', coordinates: [[[75.74, 26.84], [75.78, 26.84], [75.78, 26.88], [75.74, 26.88], [75.74, 26.84]]] },
    latestRisk: { riskTier: 'Severe', hvi: 78, forecastTempC: 43, forecastHumidity: 25, date: new Date().toISOString().split('T')[0] }
  },
  {
    wardId: 'JPR-W03', name: 'C-Scheme / Civil Lines', cityId: 'jaipur-01',
    population: 32000, pctElderly: 0.15, pctOutdoorWorkers: 0.15, greenCoverPct: 0.25,
  ...
  {
    wardId: 'JPR-W04', name: 'Vaishali Nagar', cityId: 'jaipur-01',
    population: 52000, pctElderly: 0.14, pctOutdoorWorkers: 0.28, greenCoverPct: 0.12,
  ...
  {
    wardId: 'JPR-W05', name: 'Sanganer Industrial', cityId: 'jaipur-01',
    population: 68000, pctElderly: 0.09, pctOutdoorWorkers: 0.48, greenCoverPct: 0.05,
    vulnerabilityScore: 91,
    boundary: { type: 'Polygon', coordinates: [[[75.76, 26.79], [75.82, 26.79], [75.82, 26.83], [75.76, 26.83], [75.76, 26.79]]] },
    latestRisk: { riskTier: 'Extreme', hvi: 91, forecastTempC: 45, forecastHumidity: 20, date: new Date().toISOString().split('T')[0] }
  },
  {
    wardId: 'JPR-W06', name: 'Amer Old City', cityId: 'jaipur-01',
...
export const MOCK_ALERTS = [
  { _id: 'a1', wardId: 'JPR-W05', tier: 'Extreme', channel: 'sms', recipientCount: 28400, message: 'EXTREME HEAT WARNING: Temp 45°C in Sanganer Industrial. Avoid outdoor activity 11AM-4PM. Drink ORS.', sentAt: new Date(Date.now() - 300000).toISOString(), status: 'sent' },
  { _id: 'a2', wardId: 'JPR-W02', tier: 'Severe', channel: 'sms', recipientCount: 19500, message: 'SEVERE HEAT ADVISORY: Mansarovar temp 43°C. Cooling center open at Madhyam Marg.', sentAt: new Date(Date.now() - 1200000).toISOString(), status: 'sent' },
  { _id: 'a3', wardId: 'JPR-W01', tier: 'Moderate', channel: 'sms', recipientCount: 12800, message: 'Elevated daytime temperatures expected in Malviya Nagar.', sentAt: new Date(Date.now() - 3600000).toISOString(), status: 'sent' }
];

export const MOCK_RESOURCES = [
  { _id: 'r1', wardId: 'JPR-W01', type: 'cooling_center', name: 'Malviya Community Center', address: 'Sector 3, Malviya Nagar', capacity: 150, currentOccupancy: 45, status: 'open', lat: 26.855, lng: 75.815, amenities: ['AC', 'ORS Kiosk', 'Medical Bed'] },
  { _id: 'r2', wardId: 'JPR-W01', type: 'water_station', name: 'Apex Circle Hydration Point', address: 'Apex Circle, Malviya Nagar', capacity: 500, currentOccupancy: 120, status: 'open', lat: 26.852, lng: 75.819, amenities: ['Coolers', 'Drinking Water'] },
  { _id: 'r3', wardId: 'JPR-W02', type: 'cooling_center', name: 'Mansarovar Urban Health Post', address: 'Madhyam Marg, Mansarovar', capacity: 200, currentOccupancy: 95, status: 'open', lat: 26.862, lng: 75.762, amenities: ['Misting Fans', 'Electrolyte Packs', 'Ambulance Bay'] },
  { _id: 'r4', wardId: 'JPR-W02', type: 'medical_camp', name: 'Shipra Path Emergency Heat Camp', address: 'Shipra Path, Mansarovar', capacity: 80, currentOccupancy: 60, status: 'open', lat: 26.859, lng: 75.768, amenities: ['AC', 'Rest Chairs'] },
  { _id: 'r5', wardId: 'JPR-W03', type: 'cooling_center', name: 'SMS Stadium Cooling Hub', address: 'Ambedkar Circle, C-Scheme', capacity: 300, currentOccupancy: 80, status: 'open', lat: 26.905, lng: 75.802, amenities: ['AC Hall', 'Hydration Point'] },
  { _id: 'r6', wardId: 'JPR-W04', type: 'cooling_center', name: 'Amrapali Circle Relief Point', address: 'Amrapali Circle, Vaishali Nagar', capacity: 120, currentOccupancy: 40, status: 'open', lat: 26.912, lng: 75.742, amenities: ['Chilled Ro Water', 'ORS Packets'] },
  { _id: 'r7', wardId: 'JPR-W05', type: 'cooling_center', name: 'Sanganer Mandi Emergency Shelter', address: 'Main Market, Sanganer', capacity: 250, currentOccupancy: 180, status: 'open', lat: 26.812, lng: 75.789, amenities: ['High Power Misters', 'Medical Staff'] },
  { _id: 'r8', wardId: 'JPR-W05', type: 'water_station', name: 'RIICO Industrial Hydration Station', address: 'RIICO Area, Sanganer', capacity: 600, currentOccupancy: 310, status: 'open', lat: 26.808, lng: 75.795, amenities: ['Water Tanker Kiosk'] }
];

export const MOCK_REPORTS = [
  { _id: 'rep-1', wardId: 'JPR-W05', reportType: 'heat_illness', description: 'Factory worker collapsed due to dehydration near RIICO industrial area.', severity: 'severe', status: 'investigating', reportedAt: new Date(Date.now() - 15 * 60000).toISOString(), contactPhone: '+91 98290 11234', location: 'Sanganer RIICO Area' },
  { _id: 'rep-2', wardId: 'JPR-W02', reportType: 'water_shortage', description: 'Water ATM dry outside vegetable market. Over 50 people waiting.', severity: 'severe', status: 'pending', reportedAt: new Date(Date.now() - 35 * 60000).toISOString(), contactPhone: '+91 94140 88765', location: 'Mansarovar Sector 7' },
  { _id: 'rep-3', wardId: 'JPR-W01', reportType: 'infrastructure_issue', description: 'Cooling mist fan non-functional at Apex circle bus stop.', severity: 'moderate', status: 'pending', reportedAt: new Date(Date.now() - 65 * 60000).toISOString(), contactPhone: '+91 97850 44321', location: 'Malviya Nagar Apex Circle' }
];
